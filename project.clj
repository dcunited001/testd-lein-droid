(defproject testd/testd "0.0.1-SNAPSHOT"
             ...
             [:android-common :android-user
              {:dependencies [[org.clojure-android/tools.nrepl "0.2.6"]]
               ...
               :android {:aot :all-with-unused
                         :rename-manifest-package "org.audio.testd.debug"
                         :manifest-options {:app-name "TestdListing - debug"}}}]
             :release
             [:android-common
  ...
  :android {;; Specify the path to the Android SDK directory.
            :sdk-path "/Users/dc/Library/Android/sdk/"
